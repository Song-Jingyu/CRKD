...
class AwareDBEVDepth(BaseDepthTransform):
    def __init__(
        ...
        if depth_input == 'scalar':
            self.dtransform = nn.Sequential(
                ...
                nn.BatchNorm2d(8),
                nn.ReLU(True),
                nn.Conv2d(8, 32, 5, stride=int(self.downsample_factor/4), padding=2), # Lingjun: original stride: 4
                nn.BatchNorm2d(32),
                nn.ReLU(True),
            ...
            self.dtransform = nn.Sequential(
                ...
                nn.BatchNorm2d(32),
                nn.ReLU(True),
                nn.Conv2d(32, 32, 5, stride=int(self.downsample_factor/4), padding=2), # Lingjun: original stride: 4
                nn.BatchNorm2d(32),
                nn.ReLU(True),
                nn.Conv2d(32, 64, 5, stride=2, padding=2),
                nn.BatchNorm2d(64),
    ...
    def get_cam_feats(self, x, d, mats_dict):
        B, N, C, fH, fW = x.shape
        # print("d.shape: ", d.shape) # [4, 6, 104, 256, 704]
        # print("x.shape: ", x.shape) # [4, 6, 256, 32, 88]
        ...
        # print("d.shape: ", d.shape) # (24, 64, 16, 44)
        # print("x.shape: ", x.shape) # (24, 256, 32, 88)
